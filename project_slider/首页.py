...
st.set_page_config(page_title='多页面应用-侧边导航', page_icon='💯', layout='wide')

st.title("主页")

st.image('https://www.gxvnu.edu.cn/__local/7/4F/5D/AD938A49125924C082992B16BDD_98ECEA17_BD556.jpg', use_container_width=True)
